...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <h2 class="mt-4">Maintenance Tickets</h2>
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4" onclick="redirectToMaintenance('low');">
                                <div class="card-body">
                                    Low <span class="badge bg-light text-primary" id="lowBadge">Low Priority</span>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-warning text-white mb-4" onclick="redirectToMaintenance('moderate');">
                                <div class="card-body">
                                    Moderate <span class="badge bg-light text-warning" id="moderateBadge">Moderate
                                        Priority</span>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="#">View Details</a>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-danger text-white mb-4" onclick="redirectToMaintenance('high');">
                                <div class="card-body">
                                    High <span class="badge bg-light text-danger" id="highBadge">High Priority</span>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="#">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
    ...
    <script>
        function redirectToMaintenance(urgency) {
            window.location.href = `residents/maintenance_tickets/maintenance_tickets.php?urgency=${urgency}`;
        }

        function updateTicketCounts() {
            fetch('fetch_maintenance_data.php')
                .then(response => response.json())
                .then(data => {
                    document.getElementById('lowBadge').textContent = `${data.low}`;
                    document.getElementById('moderateBadge').textContent = `${data.moderate}`;
                    document.getElementById('highBadge').textContent = `${data.high}`;
                })
