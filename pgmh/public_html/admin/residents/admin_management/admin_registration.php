        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Admin Registration</h1>
                                ...
                                <div class="col-lg-5">
                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4">Admin Registration</h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="submit_admin_registration.php" method="post">

                                                <!-- Full Name -->
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="full_name" name="full_name" type="text" placeholder="Full Name" required />
                                                ...
                                                <!-- New Admin Access Code (for setting new admin access code) -->
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="newAdminAccessCode" name="new_admin_access_code" type="password" placeholder="New Admin Access Code" required />
                                                    <label for="newAdminAccessCode">New Admin Access Code</label>
                                                </div>
