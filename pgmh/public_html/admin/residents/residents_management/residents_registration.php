...
<head>
    ...
    <title>Residents registration</title>
...
<body class="sb-nav-fixed">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link"
                                            href="../../residents/facility_reservation.php">Facility</a>
                                        <a class="nav-link"
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Resident Registration</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="../../admin_dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Resident Registration</li>
                    </ol>
                    <div class="card mb-6">
                        <div class="container">
                                ...
                                <div class="col-lg-5">
                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4">Resident Registration</h3>
                                        </div>
                                        <div class="card-body">
                                           <form id="registrationForm" action="process_registration.php" method="post">
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="inputFirstName"
                                                        name="inputFirstName" type="text" placeholder="John Doe"
                                                        required />
                                                    <label for="inpuFirstName">First Name</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="inputMiddleName"
                                                        name="inputMiddleName" type="text" placeholder="John Doe"
                                                        required />
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="inputContact" name="inputContact"
                                                        type="tel" placeholder="1234567890" required />
                                                    <label for="inputContact">Contact Number</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="inputUnit" name="inputUnit"
                                                ...
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="inputPassword">Password (Minimum 8 characters)</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" id="inputBirthday" name="inputBirthday"
                                                        type="date" placeholder="Birthday" required />
    ...
    <div class="modal fade" id="confirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmationModalLabel">Registration Complete</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="confirmRegisterBtn">OK</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    // Confirm button logic in the modal
    document.getElementById('confirmRegisterBtn').addEventListener('click', function () {
        document.getElementById('registrationForm').submit(); // Submit the form if confirmed
    });
</script>
