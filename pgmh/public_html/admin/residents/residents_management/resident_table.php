                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="../maintenance_tickets/maintenance_tickets.php">Maintenance</a>
                                    </nav>
                                </div>
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                        ...
                        <div class="collapse" id="collapseUsers" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../residents_management/residents_registration.php">Registration</a>
                                <a class="nav-link" href="resident_table.php">User Table</a>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Resident Table</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Resident Table</li>
                    </ol>
                    <div class="card mb-4">
                    </div>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="residentList" class="table">
                                <thead>
                                    <tr>
                                        <th>Full Name</th>
                                        <th>Email</th>
                                        ...
                                        <th>Added At</th> <!-- New column for added date -->
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody id="tableBody">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('data.php')
                ...
                .then(data => {
                    ...
                    const dataTable = new simpleDatatables.DataTable('#residentList');
                    ...
                    document.querySelectorAll('.archive-btn').forEach(button => {
                        button.addEventListener('click', function () {
                            ...
                            fetch('archive.php?id=' + id)
                                .then(response => response.json())
                                .then(data => {
                                    // Check if archiving was successful
                                    if (data.success) {
                                        // Remove the archived resident from the table
                                        this.closest('tr').remove();
                                        console.log('Resident with ID ' + id + ' archived successfully.');
                                    } else {
                                        console.error('Error archiving resident with ID ' + id + ': ' + data.error);
                                    }
                                })
                                .catch(error => console.error('Error archiving resident with ID ' + id + ': ' + error));
                        });
                    });
